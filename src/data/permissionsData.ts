...
export const INITIAL_AUDIT_LOGS: AuditLogEntry[] = [
  {
    id: 'AUD-900',
    timestamp: '2026-09-09 10:40:15',
    userId: 'USR-002',
    userName: 'د. م. أحمد صبري',
    userRole: 'DEPT_HEAD',
    action: 'تعديل محتويات وأصناف الطلب',
    target: 'الطلب: WDM-MI26002',
    orderReference: 'WDM-MI26002',
    category: 'CONTENT_MODIFICATION',
    details: 'تعديل صنف [لقم حفر صخري كربيد]: الكمية المطلوبة: (40 ➔ 50 قطعة)، المواصفات الفنية / رقم القطعة: (T38 ➔ T45 كربيد تنجستن 89 مم) | تعديل فترة وأيام التنفيذ المطلوبة: من "10 أيام" إلى "7 أيام عمل"',
    ...
    itemChanges: [
      {
        changeType: 'MODIFIED',
        itemNumber: 1,
        itemName: 'لقم حفر صخري كربيد التنجستن',
        specs: 'قطر 89 مم - سن تسنين T45 مع أزرار كربيد كروية',
        quantity: 50,
        unit: 'قطعة',
        diffs: [
          {
          ...
          },
          {
            ...
            oldValue: 'قطر 76 مم - سن تسنين T38',
            newValue: 'قطر 89 مم - سن تسنين T45 مع أزرار كربيد كروية',
          },
        ],
      },
      {
        changeType: 'ADDED',
        itemNumber: 2,
        itemName: 'أطواق إحكام ضغط عالي O-Rings',
        specs: 'NBR 90 Shore A لمطارق الحفر الهيدروليكية',
        quantity: 20,
        unit: 'طقم',
      },
    ],
    fieldDiffs: [
      {
        field: 'executionDays',
        fieldLabel: 'فترة وأيام التنفيذ المطلوبة',
        oldValue: '10 أيام',
        newValue: '7 أيام عمل عاجلة',
      },
      {
        field: 'requestedFrom',
        fieldLabel: 'الجهة المطلوب منها',
        oldValue: 'مستودع الخرطوم المركزي',
        newValue: 'المشتريات الخارجية والشحن الجوي المباشر',
      },
    ],
    summaryChanges: [
      'تعديل كمية لقم الحفر من 40 إلى 50 قطعة',
      'ترقية مواصفة سن التسنين من T38 إلى T45 كربيد تنجستن 89 مم',
      'إضافة صنف جديد: أطواق إحكام ضغط عالي O-Rings (20 طقم)',
      'تقليص أيام التنفيذ من 10 أيام إلى 7 أيام عمل عاجلة',
    ],
  },
  {
    id: 'AUD-901',
  ...
  },
  {
    ...
    details: 'توليد الرقم المرجعي الذكي WDM-MI26002 لعدد 40 قطعة حفر صخري عاجلة.',
  ...
  },
  {
    ...
    target: 'الطلب: WDM-EQ26001',
    orderReference: 'WDM-EQ26001',
